...
exports.newUserValidator = exports.forgot = void 0;
...
var newUserValidator = function newUserValidator(req, res, next) {
  var schema = _joi["default"].object({
    ...
    email: _joi["default"].string().required().pattern(new RegExp('^[a-zA-Z0-9]+([+_.-][a-zA-Z0-9]+)*[@][a-zA-Z0-9]+[.][a-zA-Z]{2,4}([.][a-zA-Z]{2,4})?$')),
    password: _joi["default"].string().pattern(new RegExp('(?=^.{8,}$)((?=.*\\d)|(?=.*\\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$')).required(),
...
var forgot = function forgot(req, res, next) {
  var schema = _joi["default"].object({
